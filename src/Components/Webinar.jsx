    ...
    const fetchWebinars = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `${baseURL}/webinars-by-institute/${instituteId}`
        );
    ...
    showLoginDialog && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 relative">
          ...
          <div className="mb-6">
            <p className="text-gray-600">Please log in to join this webinar.</p>
          </div>
          ...
          <div className="flex justify-end gap-4">
            ...
            <button
              className="px-4 py-2 bg-[#b82025] text-white rounded-lg hover:bg-[#b82025]"
              onClick={handleLogin}
            >
              Login
            </button>
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
        <div className="relative">
          ...
          />
          <div className="absolute top-4 right-4 bg-[#b82025] text-white px-3 py-1 rounded-full text-sm">
        ...
        <div className="p-4 flex flex-col justify-between h-[240px]">
              ...
              {webinar?.description ? (
                <div
                  dangerouslySetInnerHTML={{
                    __html:
                      webinar.description.split(" ").slice(0, 30).join(" ") +
          ...
          <div className="mt-4">
            <button
              className="w-full bg-[#b82025] text-white py-2 rounded-lg font-semibold hover:bg-[#b82025] transition duration-300"
