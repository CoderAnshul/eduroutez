...
const CounselorListPage = () => {
  ...
  return (
    ...
    {/* SEO */}
      <Helmet>
        <title> Book Your Counsellor | Eduroute counsellor</title>
        <meta
          name="Description"
          content="Find verified career counsellors stream-wise on Eduroutez. Explore Engineering, Medical, Management, Commerce, Arts, Law, IT, and other education counsellors for expert career guidance and admission support."
        />
        <meta
          name="keywords"
          content="career counsellors, education counsellors, verified counsellors, engineering counsellor, medical counsellor, management counsellor, commerce counsellor, arts counsellor, law counsellor, admission guidance, career guidance, Eduroutez counsellors"
        />
        <link rel="canonical" href="https://eduroutez.com/counselor" />
      </Helmet>

      <div className="universal-container py-12">
        {/* <h1>Explore Stream Wise Career Counsellors</h1> */}
                                ...
                                <div className="flex gap-3 mt-auto pt-6">
                                  <div className="flex-1 group relative">
                                    <button
                                      ...
                                      className={`w-full inline-flex items-center justify-center px-3 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white ${counselor.verifiedBadge
