  ...
  return (
    <div className="h-[480px] w-full bg-gray-100 banner-img">
      <div className="h-full w-full bg-[#00000049] p-2 absolute top-0 overflow-hidden z-60 flex flex-col items-center justify-center ">
        ...
        <div className="search ml-5 mr-5 h-12 bg-white border-[1.5px] border-gray-500  rounded-lg items-center gap-2 max-w-[800px] w-full overflow-hidden flex">
         <div className="flex items-center w-4/5 px-4 py-2 gap-3">
