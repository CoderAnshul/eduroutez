  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://eduroutez.com/login"
        />
        <meta
          property="og:title"
          content="Login to Eduroutez"
        />
        <meta
          property="og:description"
          content="Access your Eduroutez account as a Student, College, University, Institute, or Counselor."
        />
        <meta
          property="og:url"
          content="https://eduroutez.com/login"
        />
