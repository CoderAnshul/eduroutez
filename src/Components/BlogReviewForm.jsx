    ...
    <div className="bg-white shadow-md rounded-lg p-6">
      ...
      <div className="mb-6 flex max-sm:flex-col max-sm:items-start max-sm:gap-6 items-center justify-between">
        ...
        <button
          ...
          className="mb-4 px-6 py-2 rounded-lg font-medium bg-[#b82025] text-white hover:bg-[#b82025]"
        >
              ...
              <div className="flex">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    key={star}
                    fill={
                      (hoveredRating || rating) >= star ? "#FFD700" : "none"
                    }
                    color={
            ...
            <button
              ...
              className={`px-6 py-2 rounded-lg font-medium ${
                !currentUserId
                  ...
                  : "bg-[#b82025] text-white hover:bg-[#b82025]"
              }`}
            >
