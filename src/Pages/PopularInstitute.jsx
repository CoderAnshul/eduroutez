...
import { allPopularInstitute } from "../ApiFunctions/api";
    ...
    return (
      <div className="flex justify-center items-center h-screen text-red-500">
        <div className="text-center">
          ...
          <p>Unable to fetch popular institutes. Please try again later.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8 overflow-x-hidden">
        <div className="bg-gradient-to-r from-orange-500 to-orange-700 text-white p-16 text-center mb-12 rounded-lg shadow-lg">
          <h1 className="text-4xl font-bold mb-4">Popular Institutes</h1>
          <p className="text-xl">
            Explore the most sought-after educational institutions trusted by students across India
          </p>
        </div>

        <div className="universal-container">
          <div className="flex items-center justify-between mb-10">
            <h3 className="text-xl font-bold">Popular Institutes</h3>
