        ...
        const updatedCategories = [
          {
            ...
            contents: {
              1: [
                [
                  { name: 'Top MBA Colleges in India', link: '/searchpage?stream=Management&sort=rating' },
                  { name: 'Top MBA Colleges in Bangalore', link: '/searchpage?stream=Management&city=Bangalore' },
                  { name: 'Top MBA Colleges in Pune', link: '/searchpage?stream=Management&city=Pune' },
                  { name: 'Top MBA Colleges in Ranchi', link: '/searchpage?stream=Management&city=Ranchi' },
                  { name: 'Top MBA Colleges in Delhi', link: '/searchpage?stream=Management&city=Delhi' },
                ],
                [
                  { name: 'Top MBA Colleges in Chennai', link: '/searchpage?stream=Management&city=Chennai' },
                  { name: 'Top MBA Colleges in Hyderabad', link: '/searchpage?stream=Management&city=Hyderabad' },
                  { name: 'Top MBA Colleges in Kolkata', link: '/searchpage?stream=Management&city=Kolkata' },
                  { name: 'Top MBA Colleges in Mumbai', link: '/searchpage?stream=Management&city=Mumbai' },
                  { name: 'Top MBA Colleges in Ahmedabad', link: '/searchpage?stream=Management&city=Ahmedabad' },
                  { name: 'Top MBA Colleges in Lucknow', link: '/searchpage?stream=Management&city=Lucknow' },
                  { name: 'Top MBA Colleges in Jaipur', link: '/searchpage?stream=Management&city=Jaipur' },
                ],
                [
                  { name: 'Top MBA Colleges in Chennai', link: '/searchpage?stream=Management&city=Chennai' },
                  { name: 'Top MBA Colleges in Hyderabad', link: '/searchpage?stream=Management&city=Hyderabad' },
              ...
              2: [
                ...
                [
                  { name: 'MBA in Marketing', link: '/searchpage?stream=Management&specialization=Marketing' },
                  { name: 'MBA in Finance', link: '/searchpage?stream=Management&specialization=Finance' },
                ],
              ],
              3: [
                [
              ...
              9: [
                [
                  { name: 'Talk to MBA Students at IIM', link: '/searchpage?stream=Management&specialization=Marketing' },
                  { name: 'Talk to MBA Students at XLRI', link: '/searchpage?stream=Management&specialization=Finance' },
                ],
              ],
              10: [
                [
                  { name: 'Free Study Materials', link: '/blogpage' },
                  { name: 'Mock Test Resources', link: '/blogpage' },
                ],
                [
                  { name: 'Interview Preparation Guides', link: '/blogpage' },
                ],
              ],
              11: [
                [
                  { name: 'MBA in Operations', link: '/searchpage?stream=Management&specialization=Operations Management' },
                  { name: 'MBA in HR', link: '/searchpage?stream=Management&specialization=Human Resource Management' },
                ],
                [
                  { name: 'MBA in Business Analytics', link: '/searchpage?stream=Management&specialization=Business Analytics' },
                ],
              ],
            },
          },
          ...
          },
          {
            ...
            contents: {
              ...
              2: [
                ...
                [
                  { name: 'MBA in Tourism', link: '/searchpage?stream=Management&specialization=Tourism Management' },
