              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    Expert in: {counselor.expertise}
                  </p>
                  <p className="text-sm text-gray-600">{counselor.languages}</p>
                  <p className="text-sm text-gray-600">
                    Exp: {counselor.experience}
                  </p>
                </div>
                ...
                <button className="px-4  py-2 self-end bg-red-500 text-white text-sm font-medium rounded-lg hover:bg-red-600">
                  Connect
                </button>
                </div>
              </div>
