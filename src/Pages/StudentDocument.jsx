...
const StudentDocument = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.aadhaar)
      finalFormData.append("adharCardImage", formData.aadhaar);
    if (formData.pan) finalFormData.append("panCardImage", formData.pan);
    if (formData.profilePicture)
      finalFormData.append("profilePicture", formData.profilePicture);
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-md">
      ...
      <button
        ...
        disabled={
          isSubmitting ||
          (!formData.aadhaar && !formData.pan && !formData.profilePicture)
        }
        className="mt-6 px-4 py-2 bg-[#b82025] text-white font-medium text-sm rounded-md hover:bg-red-700 disabled:opacity-50"
      >
