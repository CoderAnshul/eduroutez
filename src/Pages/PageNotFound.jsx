...
const PageNotFound = () => {
  return (
    <>
      ...
      <div className="universal-container flex flex-col items-center justify-center text-center">
        <div className="space-y-8 max-w-2xl">
          {/* <div className="text-6xl font-bold text-[#B82025]">404</div> */}
          <h1 className="text-8xl font-bold text-[#B82025]">Page Not Found</h1>
