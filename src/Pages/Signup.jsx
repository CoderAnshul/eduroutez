...
const Signup = ({ isMode, onSwitch, onClose }) => {
  ...
  return (
    ...
    >
      {!isFlowPopupOpen && (
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl flex pt-6 pb-6 sm:pt-6 sm:pb-8 flex-col justify-start hidescrollbar items-center px-5 sm:px-8 max-h-[92vh]">
