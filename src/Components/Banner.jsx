  ...
  return (
    ...
    {/* <div className="h-fit min-h-56 max-h-96 w-full relative mb-8"> */}
      ...
      <div className="h-full w-full bg-[#00000049] p-2 absolute top-0 z-10 flex flex-col items-center justify-center">
        ...
        <Link 
          to="/compare" 
          className="bg-[#b82025] hover:bg-red-700 text-white px-8 py-3 rounded-full font-bold text-sm sm:text-base transition-all transform hover:scale-105 shadow-lg flex items-center gap-2"
        >
