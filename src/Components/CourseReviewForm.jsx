...
const CourseReviewSection = ({ course }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
      <h4 className="text-2xl font-semibold text-red-500 mb-6">
        Course Reviews
      </h4>
      ...
      <div className="flex items-center justify-between mb-8 border-b pb-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#b82025] text-white rounded-lg hover:bg-[#b82025] transition-colors"
        >
          Write a Review
        </button>
      </div>
