...
const CounselorListPage = () => {
                                                            ...
                                                            <div className="flex items-center gap-1.5">
                                                                <div className="flex">
                                                                    {[1, 2, 3, 4, 5].map((star) => (
                                                                        <svg
                                                                            key={star}
                                                                            className={`w-4 h-4 ${star <= Math.floor(calculateAverageRating(counselor.reviews)) ? 'text-yellow-400' : 'text-gray-200'}`}
                                                                            fill="currentColor"
                                                                            viewBox="0 0 20 20"
                                                                        >
  ...
  <div className="flex items-center text-sm text-gray-600">
    ...
    <span>{counselor.language}</span>
                                                            ...
                                                            {[counselor?.country, counselor?.state?.name, counselor?.city?.name].some(Boolean) && (
  <div className="flex items-center text-sm text-gray-600">
    <svg className="w-4 h-4 text-red-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <span>
      {[counselor?.country?.name, counselor?.state?.name, counselor?.city?.name]
        .filter(Boolean)
        .join(' | ')}
    </span>
  </div>
                                                            ...
                                                            {counselor.ExperienceYear && (
                                                                <div className="flex items-center gap-4 font-bold text-sm text-gray-600">
                                                                    ...
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        <span>Counselling:{counselor.schedules} Sessions</span>
                                                                    </div>
                                                                </div>
                                                            )}
                                                            ...
                                                            <div className="flex items-center text-sm text-gray-600">
                                                                ...
                                                                <span>Available on {new Date().toLocaleDateString('en-US', { weekday: 'long' })} {<DynamicSchedule slots={counselor?.slots} />}</span>
                                                            </div>
                                                        </div>
